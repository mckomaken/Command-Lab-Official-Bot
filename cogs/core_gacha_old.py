...
async def coregacha(interaction: Interaction):
    ...
    if num >= 99915:
        ...
        og1_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og1_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 2200}XP"
        )
        file1 = discord.File(
            "assets/ore_gacha/netherite_ingot.png", filename="netherite_ingot.png"
        )
        og1_embed.set_thumbnail(url="attachment://netherite_ingot.png")
        await interaction.response.send_message(
            embed=og1_embed, file=file1, silent=True
        )
        xpdb.exp += 2200
        xpdb.alladdexp += 2200
        if xpdb.exp >= 10000:
        ...
        og2_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og2_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 400}XP"
        )
        file2 = discord.File(
            "assets/ore_gacha/netherite_scrap.png", filename="netherite_scrap.png"
        )
        og2_embed.set_thumbnail(url="attachment://netherite_scrap.png")
        await interaction.response.send_message(
            embed=og2_embed, file=file2, silent=True
        )
        xpdb.exp += 400
        xpdb.alladdexp += 400
        if xpdb.exp >= 10000:
        ...
        og3_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og3_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 180}XP"
        )
        file3 = discord.File(
            "assets/ore_gacha/lapis_lazuli.png", filename="lapis_lazuli.png"
        )
        og3_embed.set_thumbnail(url="attachment://lapis_lazuli.png")
        await interaction.response.send_message(
            embed=og3_embed, file=file3, silent=True
        )
        xpdb.exp += 180
        xpdb.alladdexp += 180
        if xpdb.exp >= 10000:
        ...
        og4_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og4_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 250}XP"
        )
        file4 = discord.File("assets/ore_gacha/diamond.png", filename="diamond.png")
        og4_embed.set_thumbnail(url="attachment://diamond.png")
        await interaction.response.send_message(
            embed=og4_embed, file=file4, silent=True
        )
        xpdb.exp += 250
        xpdb.alladdexp += 250
        if xpdb.exp >= 10000:
        ...
        og5_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og5_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 150}XP"
        )
        file5 = discord.File(
            "assets/ore_gacha/gold_ingot.png", filename="gold_ingot.png"
        )
        og5_embed.set_thumbnail(url="attachment://gold_ingot.png")
        await interaction.response.send_message(
            embed=og5_embed, file=file5, silent=True
        )
        xpdb.exp += 150
        xpdb.alladdexp += 150
        if xpdb.exp >= 10000:
        ...
        og6_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og6_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 130}XP"
        )
        file6 = discord.File(
            "assets/ore_gacha/redstone_dust.png", filename="redstone_dust.png"
        )
        og6_embed.set_thumbnail(url="attachment://redstone_dust.png")
        await interaction.response.send_message(
            embed=og6_embed, file=file6, silent=True
        )
        xpdb.exp += 130
        xpdb.alladdexp += 130
        if xpdb.exp >= 10000:
        ...
        og7_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og7_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 100}XP"
        )
        file7 = discord.File("assets/ore_gacha/emerald.png", filename="emerald.png")
        og7_embed.set_thumbnail(url="attachment://emerald.png")
        await interaction.response.send_message(
            embed=og7_embed, file=file7, silent=True
        )
        xpdb.exp += 100
        xpdb.alladdexp += 100
        if xpdb.exp >= 10000:
        ...
        og8_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og8_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 85}XP"
        )
        file8 = discord.File(
            "assets/ore_gacha/iron_ingot.png", filename="iron_ingot.png"
        )
        og8_embed.set_thumbnail(url="attachment://iron_ingot.png")
        await interaction.response.send_message(
            embed=og8_embed, file=file8, silent=True
        )
        xpdb.exp += 85
        xpdb.alladdexp += 85
        if xpdb.exp >= 10000:
        ...
        og9_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og9_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 40}XP"
        )
        file9 = discord.File(
            "assets/ore_gacha/copper_ingot.png", filename="copper_ingot.png"
        )
        og9_embed.set_thumbnail(url="attachment://copper_ingot.png")
        await interaction.response.send_message(
            embed=og9_embed, file=file9, silent=True
        )
        xpdb.exp += 40
        xpdb.alladdexp += 40
        if xpdb.exp >= 10000:
        ...
        og10_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og10_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 55}XP"
        )
        file10 = discord.File(
            "assets/ore_gacha/nether_quartz.png", filename="nether_quartz.png"
        )
        og10_embed.set_thumbnail(url="attachment://nether_quartz.png")
        await interaction.response.send_message(
            embed=og10_embed, file=file10, silent=True
        )
        xpdb.exp += 55
        xpdb.alladdexp += 55
        if xpdb.exp >= 10000:
        ...
        og11_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og11_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 80}XP"
        )
        file11 = discord.File("assets/ore_gacha/coal.png", filename="coal.png")
        og11_embed.set_thumbnail(url="attachment://coal.png")
        await interaction.response.send_message(
            embed=og11_embed, file=file11, silent=True
        )
        xpdb.exp += 80
        xpdb.alladdexp += 80
        if xpdb.exp >= 10000:
        ...
        og12_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og12_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 - 100}XP"
        )
        file12 = discord.File(
            "assets/ore_gacha/breaking_pickaxe.png", filename="breaking_pickaxe.png"
        )
        og12_embed.set_thumbnail(url="attachment://breaking_pickaxe.png")
        await interaction.response.send_message(
            embed=og12_embed, file=file12, silent=True
        )
        xpdb.exp -= 100
        ...
        og13_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og13_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 - 400}XP"
        )
        file13 = discord.File(
            "assets/ore_gacha/broken_pickaxe.png", filename="broken_pickaxe.png"
        )
        og13_embed.set_thumbnail(url="attachment://broken_pickaxe.png")
        await interaction.response.send_message(
            embed=og13_embed, file=file13, silent=True
        )
        xpdb.exp -= 400
        ...
        og14_embed.set_author(
            name=interaction.user.display_name, icon_url=interaction.user.avatar.url
        )
        og14_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 - 1111}XP"
        )
        file14 = discord.File("assets/ore_gacha/death.png", filename="death.png")
        og14_embed.set_thumbnail(url="attachment://death.png")
        await interaction.response.send_message(
            embed=og14_embed, file=file14, silent=True
        )
        xpdb.exp -= 1111
...
async def coregacha9(interaction: Interaction):
    ...
    if num >= 99915:
        ...
        og1_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 30000}XP"
        )
        ...
        og2_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 20000}XP"
        )
        file2 = discord.File(
            "assets/ore_gacha/Block_of_Netherite.png", filename="Block_of_Netherite.png"
        )
        ...
        og3_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 1620}XP"
        )
        file3 = discord.File(
            "assets/ore_gacha/Block_of_Lapis_Lazuli.png",
            filename="Block_of_Lapis_Lazuli.png",
        )
        ...
        og4_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 2250}XP"
        )
        file4 = discord.File(
            "assets/ore_gacha/Block_of_Diamond.png", filename="Block_of_Diamond.png"
        )
        ...
        og5_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 1350}XP"
        )
        file5 = discord.File(
            "assets/ore_gacha/Block_of_Gold.png", filename="Block_of_Gold.png"
        )
        ...
        og6_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 1170}XP"
        )
        file6 = discord.File(
            "assets/ore_gacha/Block_of_Redstone.png", filename="Block_of_Redstone.png"
        )
        ...
        og7_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 900}XP"
        )
        file7 = discord.File(
            "assets/ore_gacha/Block_of_Emerald.png", filename="Block_of_Emerald.png"
        )
        ...
        og8_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 765}XP"
        )
        file8 = discord.File(
            "assets/ore_gacha/Block_of_Iron.png", filename="Block_of_Iron.png"
        )
        ...
        og9_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 360}XP"
        )
        file9 = discord.File(
            "assets/ore_gacha/Block_of_Copper.png", filename="Block_of_Copper.png"
        )
        ...
        og10_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 220}XP"
        )
        file10 = discord.File(
            "assets/ore_gacha/Block_of_Quartz.png", filename="Block_of_Quartz.png"
        )
        ...
        og11_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 + 720}XP"
        )
        file11 = discord.File(
            "assets/ore_gacha/Block_of_Coal.png", filename="Block_of_Coal.png"
        )
        ...
        og12_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 - 1000}XP"
        )
        file12 = discord.File(
            "assets/ore_gacha/broken_pickaxe.png", filename="broken_pickaxe.png"
        )
        ...
        og13_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 - 4000}XP"
        )
        ...
        og14_embed.set_footer(
            text=f"本日残り: {10 - ogdb.dailygacha}回 / 今日の収支: {ogdb.ogint1 - 10000}XP"
        )
        file14 = discord.File(
            "assets/ore_gacha/missing_model.png", filename="missing_model.png"
        )
...
class COregacha(commands.Cog):
    ...
    async def coregachacom(self, interaction: discord.Interaction):
        ...
        if not gachadb:
            session2.add(
                Oregacha(userid=interaction.user.id, username=interaction.user.name)
            )
            session2.commit()
            await interaction.response.send_message(
