...
class CTranslate(commands.Cog):
    ...
    @app_commands.choices(
        language=[
            ...
            app_commands.Choice(value="zh-cn", name="chinese-simplified中国簡体字"),
            app_commands.Choice(value="zh-tw", name="chinese-traditional中国繁体字"),
            ...
            app_commands.Choice(value="ht", name="haitian creole/ハイトクレオール語"),
